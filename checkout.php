...
$cartProducts = [];
$subTotal = 0;
$discount = 40; // Fixed discount, or you can fetch from DB
$couponDiscount = 10; // Fixed coupon, or fetch from DB
$tax = 2; // Fixed tax, or calculate based on cart

// Fetch cart items for the logged-in user
$sql = "SELECT c.quantity, p.productname, p.productprice 
        FROM cart c 
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-6 mb-3">
                    <div class="checkout-address">
                        ...
                        <form method="post" action="checkout_process.php" class="needs-validation" novalidate>
                            <div class="row">
                                ...
                                <?php foreach ($cartProducts as $product): ?>
                                    <div class="media mb-2 border-bottom">
                                        <div class="media-body">
                                            <a href="detail.php"><?php echo htmlspecialchars($product['productname']); ?></a>
                                            <div class="small text-muted">
                                                Price: ₹<?php echo $product['productprice']; ?>
                                                <span class="mx-2">|</span>
                                                Qty: <?php echo $product['quantity']; ?>
                                                <span class="mx-2">|</span>
                                                Subtotal: ₹<?php echo $product['totalPrice']; ?>
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="order-box">
                        ...
                        <div class="d-flex">
                            <h4>Coupon Discount</h4>
                            <div class="ml-auto font-weight-bold"> ₹<?php echo $couponDiscount; ?> </div>
                        </div>
                        <div class="d-flex">
                            <h4>Tax</h4>
                            <div class="ml-auto font-weight-bold"> ₹<?php echo $tax; ?> </div>
                        </div>
                        <div class="d-flex">
                            <h4>Shipping Cost</h4>
                            <div class="ml-auto font-weight-bold"> Free </div>
                        ...
                        <div class="col-12 d-flex shopping-box"> <a href="checkout_process.php" class="ml-auto btn hvr-hover">Place Order</a> </div>
                    </div>
                </div>
            </div>
